...
Purpose: create_soilproperties.ipynb is a Jupyter Notebook in Python developed for the purpose of creating spatially distributed soil
         and vegetation parameter files for WRF-Hydro based upon the tables provided for NoahMP and WRF-Hydro.  

Authors: G.Coelho and T.Miesse, adapted from R script developed by NCAR WRF-Hydro team

Date: March 2020

Requirements: Python, NCO, and the following R packages: ncdf4, stringr, plyr 
